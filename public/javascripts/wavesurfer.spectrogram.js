...
WaveSurfer.Spectrogram = {
    init: function (params) {
        ...
        this.height = this.fftSamples / 4 * this.pixelRatio;
    ...
    drawSpectrogram: function() {
		...
		var columnWidth = 0.01 * this.width / length;
		...
		if (chrome) {
			...
			sampleSize = Math.ceil(buffer.length / length * 0.01);
		}
		else {
		...
		function processSample() {
			...
			var context = new (window.OfflineAudioContext || window.webkitOfflineAudioContext)(1, sampleSize * 10, buffer.sampleRate);
